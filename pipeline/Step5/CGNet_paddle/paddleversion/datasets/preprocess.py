...
class TrainInform:
    ...
    def __init__(self, data_dir=DATA_DIR, classes=19,
                 train_set_file="cityscapes_trainval_list.txt", inform_data_file=INFORM_DATA_FILE_PATH, normVal=1.10):
        """
        Args:
