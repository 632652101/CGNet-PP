...
TRAIN_LIST_PATH = 'CGNet-PP/pipeline/Step2/CGNet_torch/torchvision/datasets/dataset/list/Cityscapes' \
                  '/cityscapes_train_list.txt'
VAL_LIST_PATH = 'CGNet-PP/pipeline/Step2/CGNet_torch/torchvision/datasets/dataset/list/Cityscapes' \
                  '/cityscapes_val_list.txt'
TEST_LIST_PATH = 'CGNet-PP/pipeline/Step2/CGNet_torch/torchvision/datasets/dataset/list/Cityscapes' \
...
class DataSet(data.Dataset):
    ...
    def __init__(self, root=DATA_DIR,
                 list_path=TRAIN_LIST_PATH, max_iters=None,
...
class TestDataSet(data.Dataset):
    ...
    def __init__(self, root=DATA_DIR,
                 list_path=TEST_LIST_PATH, mean=(128, 128, 128),
                 ignore_label=255):
        self.root = root
        self.list_path = list_path
        self.ignore_label = ignore_label
