...
class CGNet(nn.Layer):
    ...
    def forward(self, x):
        ...
        # return output0 # 1.862645149230957e-07
        # return inp2  # max diff 0.10114176571369171
        # return inp1  # max diff 0.15202933549880981

        # stage 2
        x = paddle.concat([output0, inp1], 1)
        # print("before concat")
        # return x  # max diff 1.862645149230957e-07
        # print("after concat")
        output0_cat = self.b1(paddle.concat([output0, inp1], 1))
        # return output0_cat  # max diff 5.811452865600586e-07

        output1_0 = self.level2_0(output0_cat)  # down-sampled

        # return output1_0  # 3.2782554626464844e-07
        ...
        # return output1_cat   # max diff 2.86102294921875e-06

        # stage 3
        output2_0 = self.level3_0(output1_cat)  # down-sampled
        # return output2_0 # mean diff 6.108643191282681e-08
        for i, layer in enumerate(self.level3):
            if i == 0:
                output2 = layer(output2_0)
                # return output2  # mean diff 8.082188429625603e-08
            else:
                # if i == 10:
                    # return output2 # mean diff 6.028684538250673e-07
                output2 = layer(output2)
        # return output2 # max diff 3.361701965332031e-05
        # return paddle.concat([output2_0, output2], 1)  # max diff 1.1235475540161133e-05
        output2_cat = self.bn_prelu_3(paddle.concat([output2_0, output2], 1))
        # return output2_cat # max diff 0.000102996826171875
        # classifier
...
class InputInjection(nn.Layer):
    def __init__(self, down_sampling_ratio):
        ...
        for i in range(0, down_sampling_ratio):
            self.pool.append(nn.AvgPool2D(3, stride=2, padding=1, exclusive=False))
